...
// import giMap from '@/data/gi_characters.json'; // ❌ ลบการ import ที่ไม่จำเป็น
// import hsrMap from '@/data/hsr_characters.json'; // ❌ ลบการ import ที่ไม่จำเป็น
...
// ❌ ลบ mapCharNameById และ prettifyCharHashLabel ออกทั้งหมด
// เนื่องจาก backend (route.ts) ถูกแก้ไขให้ส่งชื่อมาตรง ๆ แล้ว
...
                  // ❌ ลบการเรียกใช้ prettifyCharHashLabel
                  const label = base; // ⭐️ ใช้ base ที่ส่งมาจาก backend โดยตรง
